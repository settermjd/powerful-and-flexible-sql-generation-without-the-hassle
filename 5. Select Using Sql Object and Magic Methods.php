...
$select->from(['c' => 'Customer'])
    ...
    ->order('c.Country DESC')
    ->order(['i.Total DESC', 'c.LastName'])
    ->limit(30)
    ->offset(1)
    ->where->between('i.Total', $queryValues[':invoiceMin'], $queryValues[':invoiceMax'])
    ->and->equalTo('c.Country', 'USA')->or->equalTo('c.Country', 'Germany');
